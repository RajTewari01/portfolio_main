...
const fallbackCertificates: Certificate[] = [
  ...
  { id: "2", title: "Claude Code 101", issuer: "Anthropic", category: "anthropic", date_earned: "2026-04", credential_url: "/vault/Claude Code 101.pdf", image_url: null, description: "Anthropic Claude Certification", created_at: "", updated_at: "" },
  { id: "3", title: "Claude with the Anthropic API", issuer: "Anthropic", category: "anthropic", date_earned: "2026-04", credential_url: "/vault/Claude with the Anthropic API.pdf", image_url: null, description: "Anthropic Architecture", created_at: "", updated_at: "" },
  { id: "4", title: "Framework & Foundations", issuer: "AI Fluency", category: "other", date_earned: "2026-04", credential_url: "/vault/Framework & Foundations of ai fluency.pdf", image_url: null, description: "Foundations", created_at: "", updated_at: "" },
  { id: "5", title: "Introduction to Claude Cowork", issuer: "Anthropic", category: "anthropic", date_earned: "2026-04", credential_url: "/vault/Introduction to Claude Cowork.pdf", image_url: null, description: "Claude Cowork", created_at: "", updated_at: "" },
  { id: "6", title: "AI Fluency for Educators", issuer: "AI Fluency", category: "other", date_earned: "2026-04", credential_url: "/vault/ai fluency for educators.pdf", image_url: null, description: "Education", created_at: "", updated_at: "" },
  { id: "7", title: "AI Fluency for Non Profit", issuer: "AI Fluency", category: "other", date_earned: "2026-04", credential_url: "/vault/ai fluency for non profit.pdf", image_url: null, description: "Non Profit Tech", created_at: "", updated_at: "" },
  { id: "8", title: "Google Cloud Skill Badge", issuer: "Google", category: "google_skill_badge", date_earned: "2026-04", credential_url: "/vault/certificate-3vn8ztec2ege-1776608748.pdf", image_url: null, description: "Google Skill Badge", created_at: "", updated_at: "" },
  { id: "9", title: "Claude 101", issuer: "Anthropic", category: "anthropic", date_earned: "2026-04", credential_url: "/vault/claude 101.pdf", image_url: null, description: "Core concepts", created_at: "", updated_at: "" },
  { id: "10", title: "Claude Code in Action", issuer: "Anthropic", category: "anthropic", date_earned: "2026-04", credential_url: "/vault/clause code in action.pdf", image_url: null, description: "Practical coding", created_at: "", updated_at: "" },
  { id: "11", title: "Intro to Sub Agents", issuer: "DeepLearning.AI", category: "other", date_earned: "2026-04", credential_url: "/vault/into to sub agents.pdf", image_url: null, description: "Multi-agent systems", created_at: "", updated_at: "" },
  { id: "12", title: "Intro to MCP", issuer: "Anthropic", category: "anthropic", date_earned: "2026-04", credential_url: "/vault/intro to mcp.pdf", image_url: null, description: "Model Context Protocol", created_at: "", updated_at: "" },
  { id: "13", title: "MCP Advanced Topics", issuer: "Anthropic", category: "anthropic", date_earned: "2026-04", credential_url: "/vault/mcp advanced topics.pdf", image_url: null, description: "Advanced Protocol Specs", created_at: "", updated_at: "" },
  { id: "14", title: "Teaching the AI Fluency", issuer: "AI Fluency", category: "other", date_earned: "2026-04", credential_url: "/vault/teaching the ai fluency framework.pdf", image_url: null, description: "Instructional Methods", created_at: "", updated_at: "" },
];
